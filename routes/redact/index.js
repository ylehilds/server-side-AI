...
async function redactPiiFromTest (data) {
  ...
  such as all names, addresses, phone numbers, and email addresses, social security numbers, date of birth, credit card numbers, passcodes, passwords and any other sensitive data in the following text with the word "[REDACTED]":
  ${data}
  `
